...
function toolToVertex$2(fromObject) {
	...
	const fromUrlContext = getValueByPath(fromObject, ["urlContext"]);
	if (fromUrlContext != null) setValueByPath(toObject, ["urlContext"], fromUrlContext);
	if (getValueByPath(fromObject, ["mcpServers"]) !== void 0) throw new Error("mcpServers parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
function liveConnectConfigToMldev$1(fromObject, parentObject) {
	...
	const fromStreamTranslationConfig = getValueByPath(fromObject, ["streamTranslationConfig"]);
	if (parentObject !== void 0 && fromStreamTranslationConfig != null) setValueByPath(parentObject, [
		"setup",
		"generationConfig",
...
function liveConnectConfigToVertex(fromObject, parentObject) {
	...
	if (getValueByPath(fromObject, ["streamTranslationConfig"]) !== void 0) throw new Error("streamTranslationConfig parameter is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
	return toObject;
}
...
var LIBRARY_LABEL = `google-genai-sdk/2.4.0`;
